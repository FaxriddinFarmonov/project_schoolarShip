...
from app.BankSerializer.block_cardSer import BlockCardSerializer
...
@api_view(["POST"])
def block_card_api(request):
    """
    Kartani bloklash API (ModifyToken -> Blocked)
    """
    serializer = BlockCardSerializer(data=request.data)
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    ...
    try:
        ...
        response_message = "Karta bloklandi ✅"
